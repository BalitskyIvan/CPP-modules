...
ClapTrap::ClapTrap(ClapTrap &clapTrap) {
	std::cout << "Clap trap " + getName() + " constructor called" << std::endl;
	this->maxEnergyPoints = clapTrap.getMaxEnergyPoints();
	this->maxHitPoints = clapTrap.getMaxHitPoints();
	this->meleeAttackDamage = clapTrap.getMeleeAttackDamage();
	this->rangedAttackDamage = clapTrap.getRangedAttackDamage();
	this->armorDamageReduction = clapTrap.getArmorDamageReduction();
